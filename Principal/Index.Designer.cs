namespace Principal
{
    partial class Index
    {
        ...
        private void InitializeComponent()
        {
            ...
            textBox1.Size = new Size(287, 19);
            textBox1.TabIndex = 0;
            textBox1.Text = "Rodando Store - Tienda de Ciclas";
            // 
            // label1
            // 
            ...
            label1.TabIndex = 1;
            label1.Text = "Compra aqui tus ciclasGo";
            // 
            // pictureBox1
            // 
            ...
            pictureBox1.Size = new Size(429, 285);
            ...
            textBox2.Location = new Point(14, 392);
            textBox2.Name = "textBox2";
            textBox2.Size = new Size(142, 19);
            textBox2.TabIndex = 3;
            textBox2.Text = "Seccion Ventas";
            // 
            // pictureBox
            // 
            pictureBox.Location = new Point(14, 423);
            pictureBox.Margin = new Padding(3, 2, 3, 2);
            pictureBox.Name = "pictureBox";
            pictureBox.Size = new Size(181, 74);
            ...
            label2.Location = new Point(304, 514);
            label2.Name = "label2";
            label2.Size = new Size(97, 17);
            label2.TabIndex = 7;
            label2.Text = "Nombre Cicla";
            // 
            // label3
            // 
            label3.AutoSize = true;
            label3.Font = new Font("Segoe UI", 10.8F, FontStyle.Regular, GraphicsUnit.Point, 0);
            label3.Location = new Point(14, 511);
            label3.Name = "label3";
            label3.Size = new Size(100, 20);
            label3.TabIndex = 8;
            label3.Text = "Nombre Cicla";
            // 
            // label4
            // 
            label4.AutoSize = true;
            label4.Font = new Font("Arial", 10.8F, FontStyle.Regular, GraphicsUnit.Point, 0);
            label4.Location = new Point(589, 514);
            label4.Name = "label4";
            label4.Size = new Size(97, 17);
            label4.TabIndex = 9;
            label4.Text = "Nombre Cicla";
            // 
            // Index
            // 
            AutoScaleDimensions = new SizeF(7F, 15F);
            AutoScaleMode = AutoScaleMode.Font;
            ClientSize = new Size(793, 528);
            Controls.Add(label4);
            Controls.Add(label3);
            Controls.Add(label2);
